		...
		{
			{
				...
				sleep 0.01;
					...
					"admincrate", "exstr", "nlist", "PV_AdminMainCode", "TPCOUNTER", "PVDZ_Hangender", "fn_filter", "vehiList", "Remexec_Bitch", "zeus_star", "tmmenu",
					...
					"ARGT_KEYDOWN", "ARGT_JUMP_w", "ARGT_JUMP_a", "bpmenu", "color_black", "fffffffffff", "markPos", "pos", "TentS", "VL", "MV", "monky", "pbx",
					"nametagThread", "spawnmenu", "sceptile15", "sandshrew", "zombieDistanceScreen", "cargodz", "R3m0te_RATSifni", "wepmenu",
					...
					"advertising_banner_infiSTAR", "atext_star_xa", "Monky_hax_dbclick", "AntiAntiAntiAntiHax", "antiantiantiantih4x", "JxMxE_Infect", "hub",
					...
					"m0nkyaatp_RANDSTR", "myvar23", "player_adminlevel", "TNK", "I_like_turtles", "BIGM", "Does_Tonic_Like_to_take_Turtle_penis_in_the_ass_LODESTARS",
