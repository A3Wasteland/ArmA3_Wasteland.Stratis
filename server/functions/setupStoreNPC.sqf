...
if (hasInterface) then
{
	...
	switch (true) do
	{
		...
		case (["VehStore", _npcName] call _startsWith):
		{
			...
			// Source: http://forums.a3wasteland.com/index.php?topic=1110.msg7001#msg7001
			// Source: https://github.com/CRE4MPIE/ArmA3_Wasteland_1.1d.Stratis/blob/9708314028219ef74c74508dfd9f64b70e99f447/server/functions/setupStoreNPC.sqf
