...
_setupObjects =
{
	...
	_missionHintText = format ["A treasure containing <t color='%1'>$175,000</t> and weapons is being recovered.<br/>If you want to capture it, you will need diving gear and an underwater weapon.", moneyMissionColor];
};
...
_successExec =
{
	...
	// Give the rewards
	{
		_x setVariable ["cmoney", 17500, true];
