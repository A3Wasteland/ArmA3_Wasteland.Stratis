...
[
	...
	["Box_FIA_Support_F", [-1.04126, 0.24707, 0], 286.415, { [_this, ["mission_Mixed","mission_General","mission_USLaunchers","mission_USSpecial","mission_Main_A3snipers"] call BIS_fnc_selectRandom] call fn_refillbox }],
	...
	["Box_FIA_Support_F", [0.470947, -0.591309, 0], 85.8074, { [_this, ["mission_Mixed","mission_General","mission_USLaunchers","mission_USSpecial","mission_Main_A3snipers"] call BIS_fnc_selectRandom] call fn_refillbox }],
