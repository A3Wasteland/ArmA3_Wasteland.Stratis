...
[
	...
	["Box_FIA_Support_F", [-6.24817, 8.69141, 0], 180, { [_this, ["mission_Mixed","mission_General","mission_USLaunchers","mission_USSpecial","mission_Main_A3snipers"] call BIS_fnc_selectRandom] call fn_refillbox }],
	...
	["Box_FIA_Support_F", [6.26294, -10.02422, 0], 180, { [_this, ["mission_Mixed","mission_General","mission_USLaunchers","mission_USSpecial","mission_Main_A3snipers"] call BIS_fnc_selectRandom] call fn_refillbox }],
