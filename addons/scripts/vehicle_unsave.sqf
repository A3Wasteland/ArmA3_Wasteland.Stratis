...
#define ERR_IN_object "Unsaving Failed! You can't do that in a vehicle."
#define ERR_DESTROYED "The vehicle is too damaged to unsave."
#define ERR_TOO_FAR_AWAY "Unsaving Failed! You are too far away from the vehicle."
#define ERR_CANCELLED "Unsaving Cancelled!"
...
_checks = {
    ...
    switch (true) do {
        ...
        default {
            _text = format["Vehicle Unsave %1%2 Complete", round(100 * _progress), "%"];
            _failed = false;
        };
    };
    [_failed, _text];
