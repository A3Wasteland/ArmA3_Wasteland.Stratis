...
[] spawn {
		...
		switch(_minutes) do
	{
		...
		((uiNamespace getVariable "osefStatusBar")displayCtrl 1000)ctrlSetText format["CPTTS.GAMESERVERS.COM:9194 | PLAYERS ONLINE: %2 | AVERAGE FPS: %1", round diag_fps, count playableUnits];
	}; 
};