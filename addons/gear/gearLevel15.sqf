...
// _crate = "Box_East_Ammo_F" createVehicleLocal position player;
...
[missionNameSpace,(_availableHeadgear + _availableHeadAccessories + _availableUniforms + _availableVests + _availableAttachments + _availableAccessories),false,false] call BIS_fnc_addVirtualItemCargo;
[missionNameSpace,(_availableMagazines),false,false] call BIS_fnc_addVirtualMagazineCargo;
[missionNameSpace,(_availablePrimary + _availableSecondary),false,false] call BIS_fnc_addVirtualWeaponCargo;
